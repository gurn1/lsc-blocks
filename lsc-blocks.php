 ...
 * @since 1.0.0
 */
function LSC_plugin_activation() {
  update_option('lsc_plugin_activation', true);
}
register_activation_hook(__FILE__, 'LSC_plugin_activation');
 ...
 * @since 1.0.0
 */
function LSC_plugin_deactivation() {
  flush_rewrite_rules();
}
register_deactivation_hook(__FILE__, 'LSC_plugin_deactivation');